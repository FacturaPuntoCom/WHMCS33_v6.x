    ...
    <table id="adminInvoices" width="100%" cellspacing="1" cellpadding="3">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="{$systemURL}modules/addons/facturacom/lib/downloadhandler.php?uid={$invoice.UID}&type=pdf&name={$invoice.Folio|base64_encode}&version={$invoice.Version}" target="_blank">PDF</a></td>
                <td><a href="{$systemURL}modules/addons/facturacom/lib/downloadhandler.php?uid={$invoice.UID}&type=xml&name={$invoice.Folio|base64_encode}&version={$invoice.Version}" target="_blank">XML</a></td>
                <td>
