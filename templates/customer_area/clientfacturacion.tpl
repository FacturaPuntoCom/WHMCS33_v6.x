            ...
            {foreach key=num item=invoice from=$clientInvoices}
                <tr>
                    ...
                    <td class="responsive-edit-button">
                        <a href="{$systemURL}modules/addons/facturacom/lib/downloadhandler.php?uid={$invoice.UID}&type=pdf&name={$invoice.Folio|base64_encode}&version={$invoice.Version}" target="_blank" class="btn-send-email btn btn-info">
                            <span class="glyphicon glyphicon-file"></span>
                            Descargar PDF
                        </a>
                    </td>
                    <td class="responsive-edit-button">
                        <a href="{$systemURL}modules/addons/facturacom/lib/downloadhandler.php?uid={$invoice.UID}&type=xml&name={$invoice.Folio|base64_encode}&version={$invoice.Version}" target="_blank" class="btn-send-email btn btn-info">
                            <span class="glyphicon glyphicon-file"></span>
                            Descargar XML
                        </a>
                    </td>
